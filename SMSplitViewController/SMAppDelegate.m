...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    tab1VC.siteURL = @"www.evernote.com";
    ...
    tab2VC.siteURL = @"www.facebook.com";
    ...
    tab3VC.siteURL = @"www.plus.google.com";
    ...
    tab4VC.siteURL = @"www.instagram.com";
